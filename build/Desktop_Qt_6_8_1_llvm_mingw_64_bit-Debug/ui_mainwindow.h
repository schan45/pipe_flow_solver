...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        curvedPipeSpinBox->setMaximum(120);
...
"}"));
        ...
        addSourcePushButton->setFont(font2);
        label_14 = new QLabel(centralwidget);
        label_14->setObjectName("label_14");
        label_14->setGeometry(QRect(340, 10, 441, 141));
        QFont font3;
...
"alternate-background-color: rgb(0, 0, 0);"));
        ...
        tileGrid = new QWidget(centralwidget);
        tileGrid->setObjectName("tileGrid");
        tileGrid->setGeometry(QRect(320, 150, 691, 691));
        gridLayoutWidget = new QWidget(tileGrid);
        gridLayoutWidget->setObjectName("gridLayoutWidget");
        gridLayoutWidget->setGeometry(QRect(0, 0, 691, 691));
